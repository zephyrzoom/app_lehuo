...
public class QueueActivitySFJ extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_queue_sfj);
			...
			public void gotoMyQueue() {
				mHandler.post(new Runnable() {
					public void run() {
						...
						intent.setClass(QueueActivitySFJ.this,
			...
			public void alert(final int table) {
				mHandler.post(new Runnable() {
					public void run() {
						...
						new AlertDialog.Builder(QueueActivitySFJ.this)
								.setTitle("提示")
								.setMessage("确认排队?")
		...
		mWebView.loadUrl("file:///android_asset/layout_html/Queue_SFJ.html");
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.myfile) {
			Intent intent = new Intent();
			intent.setClass(QueueActivitySFJ.this, MyfileActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
			...
			Intent intent = new Intent();
			intent.setClass(QueueActivitySFJ.this, HomeActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
		}
