...
public class QueueActivityHJH extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_queue_hjh);
			...
			public void gotoMyQueue() {
				mHandler.post(new Runnable() {
					public void run() {
						...
						intent.setClass(QueueActivityHJH.this,
			...
			public void alert(final int table) {
				mHandler.post(new Runnable() {
					public void run() {
						...
						new AlertDialog.Builder(QueueActivityHJH.this)
								.setTitle("提示")
								.setMessage("确认排队?")
		...
		mWebView.loadUrl("file:///android_asset/layout_html/Queue_HJH.html");
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.myfile) {
			Intent intent = new Intent();
			intent.setClass(QueueActivityHJH.this, MyfileActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
			...
			Intent intent = new Intent();
			intent.setClass(QueueActivityHJH.this, HomeActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
		}
