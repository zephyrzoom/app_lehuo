...
public class QueueActivityHospitalJDEF extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_queue_hospital_jdef);
			...
			public void gotoMyQueue() {
				mHandler.post(new Runnable() {
					public void run() {
						...
						intent.setClass(QueueActivityHospitalJDEF.this,
			...
			public void alert(final int table) {
				mHandler.post(new Runnable() {
					public void run() {
						...
						new AlertDialog.Builder(QueueActivityHospitalJDEF.this)
								.setTitle("提示")
								.setMessage("确认排队?")
										...
										new DialogInterface.OnClickListener() {
											public void onClick(
												...
												startActivity(new Intent(
														QueueActivityHospitalJDEF.this,
														MyQueueActivityHospital.class));
		...
		mWebView.loadUrl("file:///android_asset/layout_html/Queue_hospital_JDEF.html");
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.myfile) {
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalJDEF.this, MyfileActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
			...
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalJDEF.this, HomeActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
		}
