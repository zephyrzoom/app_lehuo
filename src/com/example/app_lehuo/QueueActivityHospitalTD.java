...
public class QueueActivityHospitalTD extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_queue_hospital_td);
			...
			public void gotoMyQueue() {
				mHandler.post(new Runnable() {
					public void run() {
						...
						intent.setClass(QueueActivityHospitalTD.this,
			...
			public void alert(final int table) {
				mHandler.post(new Runnable() {
					public void run() {
						...
						new AlertDialog.Builder(QueueActivityHospitalTD.this)
								.setTitle("提示")
								.setMessage("确认排队?")
		...
		mWebView.loadUrl("file:///android_asset/layout_html/Queue_hospital_TD.html");
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.myfile) {
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalTD.this, MyfileActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
			...
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalTD.this, HomeActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
		}
