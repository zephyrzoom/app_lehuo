...
public class QueueActivityHospitalXAHR extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_queue_hospital_xahr);
			...
			public void gotoMyQueue() {
				mHandler.post(new Runnable() {
					public void run() {
						...
						intent.setClass(QueueActivityHospitalXAHR.this,
								MyQueueActivityHospital.class);
			...
			public void alert(final int table) {
				mHandler.post(new Runnable() {
					public void run() {
						...
						new AlertDialog.Builder(QueueActivityHospitalXAHR.this)
								.setTitle("提示")
								.setMessage("确认排队?")
										...
										new DialogInterface.OnClickListener() {
											public void onClick(
												...
												startActivity(new Intent(
														QueueActivityHospitalXAHR.this,
														MyQueueActivityHospital.class));
		...
		mWebView.loadUrl("file:///android_asset/layout_html/Queue_hospital_XAHR.html");
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.myfile) {
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalXAHR.this, MyfileActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
			...
			Intent intent = new Intent();
			intent.setClass(QueueActivityHospitalXAHR.this, HomeActivity.class);
			Bundle bundle = new Bundle();
			intent.putExtras(bundle);
			startActivity(intent);
		}
